...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OSSBackupStorage) DeepCopyInto(out *OSSBackupStorage) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OSSBackupStorage.
func (in *OSSBackupStorage) DeepCopy() *OSSBackupStorage {
	if in == nil {
		return nil
	}
	out := new(OSSBackupStorage)
